                ...
                <div className="mx-auto max-w-5xl rounded-3xl bg-white/60 p-8 shadow-sm backdrop-blur-sm">
                    ...
                    {showFilter && (
                        <div className="mb-6 rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
                            <p className="mb-3 text-sm font-semibold text-slate-700">Filter Spesialis</p>
                            <div className="flex flex-wrap gap-2">
                                {['Semua', 'Spesialis Gizi Klinik', 'Spesialis Anak', 'Spesialis Bedah', 'Spesialis Penyakit Dalam'].map((s, i) => (
                                    <button key={i} className="rounded-full border border-green-600 px-3 py-1 text-xs font-medium text-green-700 transition hover:bg-green-600 hover:text-white">
                                        {s}
                                    </button>
                                ))}
                            </div>
                                    ...
                                    <div className="p-4">
                                        ...
                                        <div className="flex items-center gap-1 text-xs text-slate-500">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-3-3v6m9-3a9 9 0 1 1-18 0 9 9 0 0 1 18 0z" />
                                            </svg>
                                            {dokter.spesialis}
                                        </div>
                                        <Link
